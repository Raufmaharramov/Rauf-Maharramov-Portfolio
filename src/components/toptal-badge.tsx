...
export function ToptalBadge() {
  return (
    <a
      href="https://www.toptal.com/developers/resume/rauf-maharramov#ZZVjV8"
      target="_blank"
      rel="noopener noreferrer"
      className="group inline-block"
      aria-label="Hire me on Toptal - Top 3% Talent Vetted by Toptal"
    >
      <div
      ...
      >
        <div
          className="flex flex-col items-center gap-2 px-6 pb-10 pt-6 text-center"
          style={{
            width: '200px',
            background:
        ...
        >
          ...
          <div className="h-px w-28 bg-[#25a9ef]" />
          <span style={{ fontSize: '16px', marginBottom: '-6px', color: '#204ecf' }}>Vetted by</span>
          ...
          <span
            className="inline-flex items-center justify-center rounded-md px-5 py-1 text-base font-medium text-white transition-transform group-hover:scale-105"
            style={{
              background: '#296bff',
